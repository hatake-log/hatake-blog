...
つまりウォレットは金庫ではなく、帳簿を覗いて実印を押すための**窓口**のような役割をしています。窓口が閉まっても、帳簿と記載は向こう側（チェーン上）に残っています。
...
（この「鍵を誰が持つか」という軸は、後日書いた[ステーキングの記事](/posts/staking-basics/)にも出てきます。取引所にステーキングを任せるかどうかを考えるときの判断材料も、結局これでした）
