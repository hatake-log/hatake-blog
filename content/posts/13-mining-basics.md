...
{{< figure src="/images/mining-basics-lottery02.png" alt="ヘルメットをかぶった緑のキャラクター3人が、くじ引きの箱に手を入れているイラスト。まわりにはハッシュ値が書かれたくじの紙が散らばっている" caption="**Step2**：下書き採用戦争！000000・・・で始まるクジを引き当てろ！" >}}
...
このあたりは私自身ややこしくってもう少し詳しく知りたいので、[別の記事](/posts/pow-hand-mining/)でターミナルを使って実際に試してみました。

## マイニングの報酬

{{< figure src="/images/mining-basics-new-page.png" alt="「new page!」と書かれた帳簿に新しいページが綴じられ、それを見上げて喜んでいる緑のキャラクターのイラスト" caption="**Step4**：勝者の下書きが、帳簿の新しいページになりました！" >}}
